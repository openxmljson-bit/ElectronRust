    ...
    },
    {
      ...
      submenu: [
        ...
        },
        {
          label: 'Table Theme',
          submenu: [
            ['default', 'Default'], ['striped', 'Striped'], ['clean', 'Clean (no stripes)'],
            ['ocean', 'Ocean · blue'], ['forest', 'Forest · green'], ['grape', 'Grape · purple'],
            ['amber', 'Amber'], ['rose', 'Rose · pink'], ['teal', 'Teal · cyan'],
            ['coral', 'Coral'], ['slate', 'Slate · grey'], ['indigo', 'Indigo'],
          ].map(([name, label]) => ({
            label,
            type: 'radio',
            checked: (getSettings().tableTheme || 'default') === name,
